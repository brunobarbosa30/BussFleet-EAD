...
def home(request):
    if request.session.get('usuario'):
        ...
        return render(request, 'home.html', {'cursos': cursos, 'request_usuario': request_usuario, 'usuario_logado': request.session.get('usuario')})
    else:
...
def curso(request, id):
    ...
    return render(request, 'curso.html', {'aulas': aulas, 'usuario_logado': request.session.get('usuario')})
